    ...
    <Card className="w-[600px] shadow-md">
      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
          ...
          <p className="text-xs max-w-[180px] font-mono p-1 bg-slate-100 rounded-md hover:cursor-default">
            {user?.name}
          </p>
        </div>
        ...
        <div className="flex flex-row items-center justify-between rounded-lg border p-3 shadow-sm">
          ...
          <span className="text-xs max-w-[180px] font-mono hover:cursor-default">
...
// this component will be an dynamic agnostic component that can be used in both the client and server
